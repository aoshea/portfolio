...
var Kaleidoscope = {
  imageList: [
    ...
    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Mario_Testino_2014.jpg/800px-Mario_Testino_2014.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Rio_de_Janeiro_Brazil_slum_Pav%C3%A3ozinho_favela_December_2008.jpg/1024px-Rio_de_Janeiro_Brazil_slum_Pav%C3%A3ozinho_favela_December_2008.jpg",
  ...
  resetPattern() {
    this.pattern = this.buffer.createPattern(
      this.imageElements[this.options.index],
      "repeat"
    );
